...
- اگر سرور شما مشکل dns دارد اول مشکل ان را رفع کنید یا از سرور و Os آی استفاده کنید که چنین مشکلی ندارد
- ترجیجا از دبیان 12 استفاده نمایید. من بر روی دبیان 12 و amd مشکلی نداشتم
- اگر از os ای استفاده میکنید که مشکلات iproute و wireguard tools دارد لطفا اطمینان یابید که چنین مشکلاتی ندارد . در این پنل از مسیر لصلی دستورات که داخل sbin هستند استفاده شده است/چند نمونه مثال پایین اوردم. اگر این مورد خیلی اذیت کرد لطفا اطلاع دهید که مسیر اصلی را پاک کنم و این مشکل حل بشود اما نباید روی بیشتر os ها مشکلی داشته باشد
```
sudo apt update
...
```
- باید توجه داشته باشید که از داخل موبایل من پنل را تست نکردم. یا با کامپیوتر به ان متصل شوید یا از طریق بات
- کانفیگ وایرگارد را از wg0.conf آغاز کنید
