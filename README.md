...
نام پروژه :  داشبورد وایرگارد با ربات
---------------------------------------------------------------
----------------------------------
...
- در این پروژه در صورت نصب، از وارپ پایه به صورت وایرگارد یا xray استفاده کردم تا بعدا ببینم چطور است اما فکر نکنم برای یوزر بالا مناسب باشد و این مورد یا برای استفاده شخصی مناسب باشد یا 5 نفر.(در صورت نیاز بعدا اپدیت میشود)
...
- در صورت تانل کردن وایرگارد چه با پورت فوروارد یا تانل های دیگر، باید دقت نمایید در صورت 92B در قسمت RX ممکن است مشکل شما با ریست کردن کامپیتور خود و خالی کردن data storage و cache وایرگارد در موبایل خود حل شود و حتما به دلیل مشکل تانل یا پنل نمیباشد چون پنل کاری با تانل شما ندارد
...
- توجه داشته باشد دکمه فعال و غیر فعال کردن، حجم و زمان هم ریست میکند و در بات هم به همین صورت است
...
- دارای اسکریپت نصب
- دارای ربات ادمین برای ساخت و ویرایش کاربر و سایر موارد به زبان انگلیسی و فارسی ( از داخل پنل نصب میشود)
...
- نخست گزینه ها را به ترتیب نصب میکنید تا به گزینه 3 برسید
<p align="right">
...
- سپس گزینه 5 و 6 اسکریپت را نصب کنید و پنل شما اماده است
