...
**مشکل پاک کردن db به دلیل overwrite و اختلال بین scheduler وجود دارد. شاید از sqlite استفاده کنم)** (فعلا از پنل استفاده نکنید تا این مشکل حل شود گرچه با گرفتن بک اپ های متوالی میتوان استفاده کرد)
