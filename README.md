...
**بعد از اینکه مشکلات پنل‌ را کمتر کردم، قالب کاربر برای مشاهده کانفیگ و تغییراتی در بات خواهم داد**

**همیشه قسمت اپدیت را مطالعه بفرمایید و نسبت به اپدیت پنل اقدام نمایید. از طریق لینک اسکریپت و گزینه 1**

**این پروژه اموزشی است و استفاده از ان بر عهده شما می‌باشد. در صورت وجود مشکل باعث ناراحتی شما نشود**
 <div align="right">
  <details>
...
- اپدیت برای اسکریپت که از این به بعد قالب های شما را overwrite نکند . از طریق اسکریپت داخل گیت هاب اپدیت نمایید
  </details>
</div>
