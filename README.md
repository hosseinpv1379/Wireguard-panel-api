...
**برای کاربرها، template مشاهده کانفیگشان اضافه شد. در داخل بات پس از ساخت کانفیک، در قسمت دانلود کانفیگ یا qr به عنوان لینک کوتاه، کانفیگ خودشان را میتوانند مشاهده کنند.**(داخل اسکرین شات مشاهده نمایید)

**در قسمت وارپ با xray به دلیل استفاده از خود وایرگارد، ممکن است کار نکند و باید بعدا به این موضوع نگاه کنم و در صورت عدم موفقیت از پنل‌ پاک میکنم**
...
- برای کاربرها template مشاهده کانفیگشان اضافه شد. در داخل بات پس از ساخت کانفیک در قسمت دانلود کانفیگ یا qr به عنوان لینک کوتاه کانفیگ قابل مشاهده است. در دانلود کانفیگ و qr هم به صورت جداگانه نشان داده خواهد شد
...
- اگر تمام کارهای پنل به درستی پیش برود و مشکل خاصی نباشد بعدا شاید در صورت امکان مشاهده ایپی های کاربران و بستن و باز کردن ان هم به پنل هم اضافه کنم که در صورت وجود تانل به صورت 127.0.0.1 نشان میداد.
- ممکن است وارپ با xray آز پنل حذف شود چون از خود وایرگارد استفاده میکنیم و به wgcf نسخه پلاس اضافه شود
