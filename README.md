...
**بعد از اینکه مشکلات پنل‌ را کمتر کردم ( مشکل پاک کردن db به دلیل overwrite و اختلال بین scheduler وجود دارد) ، قالب کاربر برای مشاهده کانفیگ را کار خواهم کرد** ( اگر درخواستی برای قابلیتی دارید داخل issues بیان کنید)
