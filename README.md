...
**شاید فردا template کاربرها را اضافه کنم. فعلا اسکرین شات ان را اضافه کرده ام. به صورت یک لینک برای هر کاربر داده میشود.قسمت frontend ان و بات مانده است**(تغییراتی داده خواهد شد)
