...
- این پروژه آموزشی برای یادگیری بیشتر در این زمینه میباشد و امیدوارم به کار شما بیاید ( استفاده از آن بر عهده شما میباشد به این معنی که ممکن نیاز های شما را برطرف نکند. بهتر است نخست ان را تست کنید و اگر از ان اطمینان یافتید ، از ان استفاده نمایید).
