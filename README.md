...
**برای کاربرها template مشاهده کانفیگشان اضافه شد. در داخل بات پس از ساخت کانفیک در قسمت دانلود کانفیگ یا qr به عنوان لینک کوتاه کانفیگ ثابل مشاهده است.**(داخل اسکرین شات مشاهده نمایید)

**در قسمت وارپ با xray به دلیل استفاده از خود وایرگارد، ممکن است کار نکند و باید بعدا به این موضوع نگاه کنم و در صورت عدم موفقیت اژ پنل‌ پاک میکنم**
