...
**مشکل پاک کردن db به دلیل overwrite و اختلال بین scheduler وجود دارد.فعلا چندین قفل اضافه شده است. فعلا به نظر مشکل حل شده است**(حتما به صورت متداول بک اپ بگیرید تا مشکلی پیش نیاید)
