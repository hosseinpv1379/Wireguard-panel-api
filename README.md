...
- اگر سرور شما مشکل dns دارد اول مشکل ان را رفع کنید یا از سرور و Os ای استفاده کنید که چنین مشکلی ندارد
...
- فغلا مسیر اصلی دستورات را پاک کردم و این مورد در bandit به عنوان مورد در نظر گرفته میشود تا ببینم بعدا چی میشه
```
sudo apt update
