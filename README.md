...
---------------------------------------------------------------
----------------------------------
**بعد از اینکه مشکلات پنل‌ را کمتر کردم، قالب کاربر برای مشاهده کانفیگ و تغییراتی در بات خواهم داد** ( پنل فعلا مشکل ریست شدن حجم بعد از ریبوت را به دلیل ریست wg دارد که درست میشود. فعلا ریبوت نکنید)
