...
- تنها chat admin id دسترسی به بات را خواهد داشت
- در قسمت peer creation ، اطلاعات کاربر ساخته شده کامل تر شد و mtu هم به ان اضافه شد
- فسمت first usage همان محاسبه زمان پس از اتصال اول میباشد
- در قسمت settings مشکل mtu برطرف شد
  </details>
</div>
